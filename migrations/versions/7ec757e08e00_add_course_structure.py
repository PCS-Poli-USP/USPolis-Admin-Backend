...
def upgrade() -> None:
    ...
    sa.Column('period', sa.Enum('MORNING', 'AFTERNOON', 'EVENING', 'INTEGRAL', name='course_period_type'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['updated_by_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('course_id', 'name', name='unique_emphasis_name_for_course')
    )
    ...
    sa.ForeignKeyConstraint(['course_id'], ['course.id'], ),
    sa.ForeignKeyConstraint(['created_by_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['emphasis_id'], ['emphasis.id'], ),
    sa.ForeignKeyConstraint(['updated_by_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('type', sa.Enum('SEMESTRAL', 'QUADRIMESTER', name='curriculum_subject_type'), nullable=False),
    sa.Column('period', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['curriculum_id'], ['curriculum.id'], ),
    sa.ForeignKeyConstraint(['subject_id'], ['subject.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('curriculum_id', 'subject_id', name='unique_subject_for_curriculum')
    )
