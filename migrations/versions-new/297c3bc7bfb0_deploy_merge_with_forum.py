...
Revision ID: 297c3bc7bfb0
Revises: 
Create Date: 2024-11-14 20:56:01.590024
...
def upgrade() -> None:
    ...
    sa.Column('class_id', sa.Integer(), nullable=False),
    sa.Column('subject_id', sa.Integer(), nullable=False),
    sa.Column('reply_of_post_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['created_by_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('date', 'category_id', name='unique_holiday_date_for_category')
    )
